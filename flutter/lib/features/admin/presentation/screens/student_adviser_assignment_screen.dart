              ...
              builder: (context, constraints) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final assignment = adviserProvider.getStudentAssignment(
                      student.studentId,
                    );
                    final selectedAdviser =
                        _selectedAdvisers[student.studentId] ??
                        (assignment != null && assignment.adviserId != null
                            ? adviserProvider.advisers.firstWhere(
...
=======
          return _buildBody(adviserProvider);
>>>>>>> b399481542d8197646b57ad199b7e5030298c80f
        },
      ),
    );
