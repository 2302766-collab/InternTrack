...
class DailyTimeRecordExportTest extends TestCase
{
    ...
    public function test_student_can_view_monthly_dtr_rows_for_table_display(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.rows.1.am_time_in_at', '2026-04-02T08:10:00+00:00')
            ->assertJsonPath('data.rows.1.am_time_out_at', '2026-04-02T12:02:00+00:00')
            ...
            ->assertJsonPath('data.rows.1.pm_time_in_at', '2026-04-02T13:05:00+00:00')
            ->assertJsonPath('data.rows.1.pm_time_out_at', '2026-04-02T17:01:00+00:00')
