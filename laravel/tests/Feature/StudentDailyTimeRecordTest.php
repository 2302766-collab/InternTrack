...
class StudentDailyTimeRecordTest extends TestCase
{
    ...
    public function test_student_can_complete_the_full_daily_time_record_flow(): void
    {
        ...
        $this->postJson('/api/v1/student/dtr/time-in')
            ...
            ->assertJsonPath('data.am_time_in_at', '2026-04-11T08:00:00+08:00')
        ...
        $this->postJson('/api/v1/student/dtr/lunch-out')
            ...
            ->assertJsonPath('data.am_time_out_at', '2026-04-11T12:30:00+08:00')
            ->assertJsonPath('data.lunch_out_at', '2026-04-11T12:30:00+08:00')
        ...
        $this->postJson('/api/v1/student/dtr/lunch-in')
            ->assertOk()
            ->assertJsonPath('data.status', 'WORKING')
            ->assertJsonPath('data.lunch_in_at', '2026-04-11T13:30:00+08:00')
            ->assertJsonPath('data.pm_time_in_at', '2026-04-11T13:30:00+08:00')
        ...
        $this->postJson('/api/v1/student/dtr/time-out')
            ...
            ->assertJsonPath('data.pm_time_out_at', '2026-04-11T17:00:00+08:00')
